...
test whether the locally inferred `6.7 kHz` detuning is stable on hardware.
...
|---|---|---|---:|---:|---:|
| Previous | `d9nl3d6ij12s73fu19kg` | 2026-08-02 22:30 | 6.80 kHz | 390.4 us | 0.0355 |
| Repeat | `d9ntoj460llc73cagtgg` | 2026-08-03 08:48 | 9.55 kHz | 443.9 us | 0.0380 |

The repeated run clearly shows an oscillatory Ramsey trace, with a comparable
single-tone fit residual. However, the fitted frequency shifted by `2.75 kHz`
...
2. A fixed `6.7 kHz` detuning is not established by these two runs.
