...
- Fitted frequency: `9.55 kHz`
- Fitted T2: `443.9 us`
- Fit RMSE: `0.0380`
- Previous dense estimate: `6.80 kHz`, `390.4 us`, RMSE `0.0355`

The Ramsey oscillation is qualitatively reproducible, but the fitted frequency
changed by `2.75 kHz`. Therefore the local `6.7 kHz` detuning remains an
...
- The Ramsey-scale `6.8` to `9.55 kHz` oscillation was not recovered as a
