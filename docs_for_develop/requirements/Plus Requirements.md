...
> explicit non-features are listed in `docs_for_develop/README.md`.

## 目的

この文書は、Yuragi-Strider の本開発必達範囲には含めないが、将来的な拡張候補として検討する機能を整理する。
...
- Yuragi-Strider の中核は、弱結合開放系に基づく小規模量子回路の劣化可視化である
...
Godotを用いて、Yuragi-Strider の入門者向け体験UIを試作する。
